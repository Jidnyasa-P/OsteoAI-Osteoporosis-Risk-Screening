      ...
      <section className="py-10 px-6 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-sm font-bold text-blue-600 uppercase tracking-[0.2em] mb-2">Why Choose OsteoScan AI</h2>
      ...
      <footer className="py-12 border-t border-slate-100 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center">
            ...
            <span className="text-xl font-black text-slate-900">OsteoScan AI</span>
          </div>
          <div className="text-slate-400 text-sm font-medium">
            © 2026 OsteoScan AI Technologies. All rights reserved.
          </div>
